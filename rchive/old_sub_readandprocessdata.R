...
# Check with leontine, Is 0 a potential code for missing data
...
#mering data while excluding missing values which are represented in logical vector exclude
df[,1] <- NULL # removes 
...
#dim(cppred)
# check if African has region Southern Africa
cppred <- area
if (SSA== TRUE){
...
# also add CPR Ignore this portion 
